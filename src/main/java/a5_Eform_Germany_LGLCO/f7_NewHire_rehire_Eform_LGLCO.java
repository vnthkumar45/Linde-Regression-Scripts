...
public class f7_NewHire_rehire_Eform_LGLCO extends AgentGenericMethods2 {
	...
	public static void NewHire_Rehire_Eform_Verification_and_Submission(String URL, String ScreenshotPath,
		...
		ReadExcel(EformPath);
		try {
			String Login_sheet_name = "DE_Newhire_rehire";
			...
			for (int i = 1; i <= totalRows; i++) {// declaring while loop to iterate in sheet untill we have rows
				...
				if (EformName.isEmpty()) {
					...
					Class1_MyHR_genericMethods.Populate_fields_and_Submit_Eform(Scenario,"Newhire_Rehire_LGLCO", RequestRaisedFor, MethodName);
